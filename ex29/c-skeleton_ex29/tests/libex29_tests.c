...
char *test_functions()
{
    mu_assert(check_function("print_a_message", "Hello", 6, 0),
            "print_a_message failed.");
    mu_assert(check_function("uppercase", "Hello", 6, 0),
            "uppercase failed.");
    mu_assert(check_function("lowercase", "Hello", 6, 0),
            "lowercase failed.");
...
char *test_failures()
{
    mu_assert(check_function("fail_on_purpose", "Hello", 6, 1),
