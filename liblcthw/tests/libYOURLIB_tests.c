...
char *lib_file = "build/libYOURLIB.[a|so]";
void *lib = NULL;
...
char *test_functions()
{
    mu_assert(check_function("func to run", "data", 0), "func failed.");
...
char *test_failures()
{
    mu_assert(check_function("func to frun", "data", 1), "fail_on_purpose should fail.");
